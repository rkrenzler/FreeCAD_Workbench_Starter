...
class Bushing(pypeType):
	def __init__(self, obj, PSize="", dims=bushingMod.Dimensions()):
		...
		obj.addProperty("App::PropertyLength","L","Bushing","Bushing length").L=dims.L
		obj.addProperty("App::PropertyLength","N","Bushing","N").N=dims.N
		obj.addProperty("App::PropertyLength","POD","Bushing","Large pipe outer diameter.").POD=dims.POD
