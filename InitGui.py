...
class OSE_PipingWorkbench (Workbench):
    ...
    def Initialize(self):
        ...
        self.list = ["OSE_CreatePipe", "OSE_CreateCoupling", "OSE_CreateBushing", "OSE_CreateElbow", "OSE_CreateTee", "OSE_CreateOuterCorner"] # A list of command names created in the line above
