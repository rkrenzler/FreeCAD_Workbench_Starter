...
# os.path.join(OSEBase.IMAGE_PATH, "cross-dimensions.png")
	def setupUi(self, Dialog):
		...
		self.label.setText("")
		self.label.setPixmap(os.path.join(OSEBase.IMAGE_PATH, "cross-dimensions.png"))
	...
	def accept(self):
		...
		if partName is not None:
			cross = CrossFromTable(self.document, self.table)
